...
#define T1_FPGA_RAM_DISK_ADDR             0xfff1000000
...
#define T1_FPGA_STICK_FREQ                1000000000  /* OpenSPARC T1 frequency as reported to OS */
 ...
 */
#define T1_FPGA_TOTAL_MEMSIZE	          0x0AC00000  /* OpenSPARC T1 DRAM size */
